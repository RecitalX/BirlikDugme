...
namespace Kurumsal.Controllers
{
    public class HizmetController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(hizmet.ToList().OrderBy(x=>x.HizmetId));
        }
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult Edit(Hizmet m, /*string boy,*/ string renk)
        {
            ...
            //    foreach (var e in etk)
            //    {
            //        var etiketlistesi = new Boy { BoyAdi = e };
            //        db.Boy.Add(etiketlistesi);
            //        mkl.Boy.Add(etiketlistesi);
            //    }
            //    db.SaveChanges();
            //}
